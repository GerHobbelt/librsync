...
# will also work.  XXX except for regression tests with Simon's Mk-files -- they
# don't build because of PROGS.
#
...
# run the regression tests to see if the results are correct (xxx except with
# Simon's Mk-files).
#
#	bsdmake regress
#
...
#
# Note with "bmake" and bootstrap-mk-files this may cause obj* directories to be
...
bmake_install_dirs += ${DOCDIR}/lib${PACKAGE}
bmake_install_dirs += ${DOCDIR}/lib${PACKAGE}/html
bmake_install_dirs += ${DOCDIR}/lib${PACKAGE}/latex
